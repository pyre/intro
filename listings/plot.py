...
class square(pyre.component, family="plot.functors.square"):
    """
    The function x -> x^2
    """
...
# another implementation of the functor protocol
class cube(pyre.component, family="plot.functors.cube", implements=functor):
    """
    The function x -> x^3
    """
